...
//        webView.getSettings().setDisplayZoomControls(true);
    ...
    // info -  In shouldOverrideUrlLoading() we detect whether the clicked link is internal or external. If it’s external, we launch the BrowserActivity.
    ...
    // info -  Here we use a custom MyWebChromeClient() to intercept the methods of WebView.
